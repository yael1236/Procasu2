...
<div class="container text-center">
  <div class="row" >
        ...
        <div class="card" style="width: 18rem;">
  <div class="card-header">
      <h5> <a  class="text-dark link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover"href="app/php/menu.php"  ><u>Riesgos</u></a> </h5>
      <ul class="list-group list-group-flush">
      <li class="list-group-item"> 
      <label class="form-label aling-center">
